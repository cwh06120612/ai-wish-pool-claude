...
function PostAuthor({ p }: { p: TopicPost }) {
  ...
  return (
    <span className="inline-flex items-center gap-1">
      ...
      {p.authorDept && <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-[#F0F4F4] text-[#616161] border border-[#E0E0E0]">{deptLast(p.authorDept)}</span>}
    </span>
  );
}
      ...
      <div className="bg-[#EFF7F8] border border-[#007A87]/40 rounded-2xl p-5 mb-4">
        ...
        <div className="flex items-center gap-x-3 gap-y-1 mt-3 text-xs text-[#9E9E9E] flex-wrap">
          <span className="flex items-center gap-1">
            ...
            {!topic.isStaff && topic.authorDept && <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-[#F0F4F4] text-[#616161] border border-[#E0E0E0]">{deptLast(topic.authorDept)}</span>}
